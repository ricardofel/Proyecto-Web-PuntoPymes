...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    # String para evitar import circular con 'empleados.Empleado'
    ...
    def es_superadmin_negocio(self) -> bool:
        """
        True si tiene algún rol que contenga 'Super' o 'Gerente'.
        Ej: 'Superusuario', 'Super Admin', 'Gerente General'.
        """
    ...
    def es_admin_rrhh(self) -> bool:
        """
        True si tiene algún rol que contenga 'RRHH' o 'Humanos'.
        Ej: 'Admin RRHH', 'Recursos Humanos', 'Jefe RRHH'.
        """
