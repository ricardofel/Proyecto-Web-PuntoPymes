...
class UsuarioQuerySetWhiteBoxTests(TestCase):
    """
    Tests de caja blanca para métodos del UsuarioQuerySet.
    """

    def setUp(self):
        # Infraestructura base: dos empresas para validar aislamiento (multitenencia)
        ...
        # Usuarios en Empresa A (cédulas distintas para evitar colisiones por unicidad)
    ...
    def _crear_usuario_empresa(self, email, empresa, cedula):
        """Helper: crea un empleado con su usuario asociado y contraseña de prueba."""

        # Crea o reutiliza unidad/puesto para no depender de fixtures externos
        ...
        # La cédula se pasa explícitamente para respetar restricciones de unicidad
        ...
        # Recupera el usuario creado (p. ej. por señal) y define una contraseña conocida
    ...
    def test_visibles_para_aislamiento_empresas(self):
        # Valida que un usuario de una empresa solo vea usuarios de su misma empresa
        ...
        # Superuser: visibilidad total (en este escenario, excluye su propio usuario en visibles_para)
    ...
    def test_busqueda_general_logica_or(self):
        # Valida búsqueda general por campos relacionados (Usuario + Empleado)
...
class UsuarioServiceWhiteBoxTests(TestCase):
    """
    Tests de caja blanca para UsuarioService.
    """
    ...
    def setUp(self):
        ...
        # Roles usados en pruebas: RRHH, Superusuario y un rol común
    ...
    def test_mapeo_roles_a_permisos(self):
        # Valida que el servicio actualiza flags de Django (is_staff / is_superuser) según rol
...
class UsuarioDecoratorWhiteBoxTests(TestCase):
    """
    Tests de caja blanca para decoradores de seguridad.
    """
    ...
    def setUp(self):
        ...
        # Asigna rol RRHH al usuario correspondiente
    ...
    def test_decorador_acceso_denegado(self):
        # Un usuario sin permisos no debe acceder a la vista protegida
    ...
    def test_decorador_acceso_permitido(self):
        # Un usuario con rol RRHH debe acceder a la vista protegida
